...
def unet1(input_size):
    ...
    conv14 = Conv2D(2, 3, activation = 'tanh', padding = 'same',)(conv9) # 47
...
while((i<epochs_max) and (stop==0)):
    ...
    for i1 in range(N1):
        ...
        print('U_NET iteration number ',(iter1-1),' sub-iter = ',i1+1)
    ...
    np.save(cwd +'/tr_Acc_U_NET',tr_Acc)
    np.save(cwd +'/Tr_runtime_U_NET',time_Tr)